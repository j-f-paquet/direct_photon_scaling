...
system_choice='AuAu200_phenix_Ncoll'

calc_dict={
    "AuAu200_phenix_Ncoll":{
        ...
        'hadron_file':"../../../../../from_phenix/dNchdeta_phenix_20pctbins.dat",
...
photon_low_pT_cut_list=np.arange(0.8,3.2,0.2)
photon_high_pT_cut=5.0
...
photon_file_location_pre=os.path.join(curr_calc_dict['photon_file_dir'],"@source@","AuAu200","@cent@/",curr_calc_dict['photon_file_name'])
